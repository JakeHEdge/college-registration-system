...
public class ViewStudentDetailsReal {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewStudentDetailsReal window = new ViewStudentDetailsReal();
	...
	private void initialize() {
		...
		frmEnrolmentSystem.setIconImage(Toolkit.getDefaultToolkit().getImage(ViewStudentDetailsReal.class.getResource("/Images/riverside college done now.png")));
		...
		lblcollegelogo.setIcon(new ImageIcon(ViewStudentDetailsReal.class.getResource("/Images/riverside college done now.png")));
		...
		lblstudentdetails.setBounds(77, 6, 518, 44);
		...
		lblNewLabel.setIcon(new ImageIcon(ViewStudentDetailsReal.class.getResource("/Images/enrolment system backdrop.png")));
